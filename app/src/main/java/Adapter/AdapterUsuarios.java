...
public class AdapterUsuarios extends BaseAdapter {
    ...
    public AdapterUsuarios(Context ctx, List<Silos> usuarios) { // Recebendo por parametro e setando.
        this.context = ctx;
        this.lista = usuarios;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Silos usuario = lista.get(position);
        ...
        textView.setText("ID : "+ usuario.getId_silo()+"\n\nNOME: " + usuario.getNome_silo() + "\n\nProduto: " + usuario.getProduto_silo()+"  \n\nTamanho:" + usuario.getTamanho_silo() +"  \n\n");
